//
//  SubscriptionFilterViewCollectionCell.swift
//  FMSS Homework
//
...
final class SubscriptionFilterViewCollectionCell: UICollectionViewCell {
    ...
    var subscriptionTypeViewModel: SubscriptionTypeViewModel? {
        didSet {
            titleLabel.text = subscriptionTypeViewModel?.title
            if subscriptionTypeViewModel?.isSelected == true {
...
extension SubscriptionFilterViewCollectionCell {
